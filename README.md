...
- **Map**: opens the **place itself** in 高德地图 Amap, Google Maps (English reviews) or Apple Maps, so you can see its photos and reviews. Transit directions are a separate option for once you are in China. Every landmark, hotel and station carries GCJ-02 coordinates to narrow the search.
