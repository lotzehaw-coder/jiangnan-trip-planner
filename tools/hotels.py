...
# ---------------- Hangzhou ----------------
hotel('canopy', name='Canopy by Hilton Hangzhou West Lake', cn='杭州西湖希尔顿嘉悦里酒店', chain='Hilton', brand='Canopy',
      ...
      near=['broken', 'hefang'])
hotel('conrad', name='Conrad Hangzhou', cn='杭州康莱德酒店', chain='Hilton', brand='Conrad',
      ...
      near=['qianjiang'])
hotel('jwhz', name='JW Marriott Hotel Hangzhou', cn='杭州JW万豪酒店', chain='Marriott', brand='JW Marriott',
      ...
      near=['gongchen'])
hotel('azure', name='The Azure Qiantang, a Luxury Collection Hotel', cn='杭州钱塘江畔精选酒店', chain='Marriott', brand='Luxury Collection',
      ...
      near=[])
hotel('mqj', name='Hangzhou Marriott Hotel Qianjiang', cn='杭州钱江新城万豪酒店', chain='Marriott', brand='Marriott',
...
# ---------------- Nanjing ----------------
hotel('ritznj', name='The Ritz-Carlton, Nanjing', cn='南京丽思卡尔顿酒店', chain='Marriott', brand='Ritz-Carlton',
      ...
      near=['xinjiekou'])
hotel('westinnj', name='The Westin Nanjing Xuanwu Lake', cn='南京金茂威斯汀大酒店', chain='Marriott', brand='Westin',
      ...
      near=['xuanwu'])
hotel('hiltonnj', name='Hilton Nanjing', cn='南京希尔顿酒店', chain='Hilton', brand='Hilton',
      ...
      near=[])
hotel('hiltonriver', name='Hilton Nanjing Riverside', cn='南京世茂滨江希尔顿酒店', chain='Hilton', brand='Hilton',
      ...
      near=[])
hotel('jingli', name='The New Jingli Hotel (SLH)', cn='南京新晶丽酒店', chain='Hilton', brand='SLH · book on hilton.com',
...
# ---------------- Suzhou ----------------
hotel('ritzsz', name='The Ritz-Carlton, Suzhou', cn='苏州丽思卡尔顿酒店', chain='Marriott', brand='Ritz-Carlton',
...
hotel('wsz', name='W Suzhou', cn='苏州W酒店', chain='Marriott', brand='W',
      ...
      near=['jinji'])
hotel('hiltonsz', name='Hilton Suzhou', cn='苏州希尔顿酒店', chain='Hilton', brand='Hilton',
      ...
      near=['jinji'])
hotel('szmarriott', name='Suzhou Marriott Hotel', cn='苏州万豪酒店', chain='Marriott', brand='Marriott',
...
STAYS = [
 dict(id='hz1', city='Hangzhou', title='Hangzhou · first two nights', dates='Sun 15 → Tue 17 Nov', nights=2, default='canopy',
 ...
 dict(id='hz2', city='Hangzhou', title='Hangzhou · last night', dates='Tue 17 → Wed 18 Nov', nights=1, default='conrad',
 ...
 dict(id='nj', city='Nanjing', title='Nanjing', dates='Wed 18 → Fri 20 Nov', nights=2, default='ritznj',
 ...
 dict(id='sz', city='Suzhou', title='Suzhou', dates='Fri 20 → Sun 22 Nov', nights=2, default='ritzsz',
